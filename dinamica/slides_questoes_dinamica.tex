...
argumento, adaptado para a nossa \'epoca, \'e: se uma pessoa,
...
Terceira Lei de Newton define que se puxar o m\'ovel, o m\'ovel
...
dire\c{c}\~ao e o sentido da for\c{c}a de atrito
mencionada no texto?
...
$a = F/m$; o resto \'e a cinemática. Quem esquece de
...
A massa dos bonecos, as dimens\~oes dos cintos e a velocidade antes e
...
perfeitamente liso e inclinado de $37^{\circ}$ com a
horizontal.
...
\vspace{0.4em}
Desprezando o atrito, a for\c{c}a m\'inima com que o
...
\vspace{0.4em}
Qual \'e a acelera\c{c}\~ao do sistema e a for\c{c}a
