...
{\LARGE Din\^amica --- Leis de Newton e For\c{c}as}\\[0.7em]
{\itshape\color{grafite}Quest\~oes reais de ENEM e Vestibular UTFPR,
...
\begin{painel}
{\small\scshape\color{grafite}como usar esta lista}\par\smallskip
\begin{itemize}[nosep, leftmargin=1.5em]
  \item Todas as quest\~oes s\~ao de provas de verdade. A fonte e o ano
        est\~ao do lado do n\'umero. Os gabaritos foram conferidos nas
        provas e gabaritos oficiais (UTFPR) e em resolu\c{c}\~oes
        p\'ublicas (ENEM). \textit{PPL = reaplica\c{c}\~ao do ENEM
        (Pessoas Privadas de Liberdade), mesma banca e mesmo formato.}
  \item As quest\~oes marcadas com \selosala v\~ao ser resolvidas na
        aula (Bloco 5 do plano). Vale tentar antes.
  \item O resto \'e \textbf{tarefa de casa}. Come\c{c}ar por Q2, Q3 e
        Q11 (uma de cada lei).
  \item Q13 e Q14 s\~ao revis\~ao de cinem\'atica. Q15 e Q16 s\~ao
        desafios de assuntos das pr\'oximas aulas.
  \item O \textbf{gabarito comentado} est\'a no final. Tentar fazer
        antes de olhar.
\end{itemize}
\end{painel}
...
\begin{tabular}{@{}clll@{}}
  ...
  6  & UTFPR Ver\~ao 2026 & Frenagem (num\'erica)                        & \textbf{sala (b\^onus)} \\
  7  & ENEM 2009          & Massa $\times$ peso                          & casa \\
  8  & UTFPR Ver\~ao 2025 & For\c{c}a el\'astica (Lei de Hooke)          & casa \\
  9  & ENEM 2013          & 3\textordfeminine{} Lei + atrito             & \textbf{sala} \\
  10 & ENEM PPL 2012      & 3\textordfeminine{} Lei (conceito)           & \textbf{sala} \\
  11 & UTFPR Inverno 2023 & 3\textordfeminine{} Lei / propuls\~ao        & casa \\
  12 & ENEM PPL 2012      & Atrito est\'atico $\times$ cin\'etico (ABS)  & casa \\
  13 & UTFPR Ver\~ao 2024 & Revis\~ao: MRUV                              & casa \\
  14 & UTFPR Ver\~ao 2024 & Revis\~ao: gr\'afico $v \times t$            & casa \\
  15 & ENEM 2009          & Desafio: curva do trem-bala                  & casa \\
  16 & UTFPR Ver\~ao 2024 & Desafio: colis\~ao                           & casa \\
  \bottomrule
\end{tabular}}
...
\begin{questao}{6}{\selobonus\fonte{UTFPR Ver\~ao 2026 --- Q35}}
Para testar os sistemas de freio de um carro em um certo tipo de
asfalto, para simular situa\c{c}\~oes reais nas estradas brasileiras, o
fabricante realizou testes da frenagem de seu novo carro pr\'oximo do
limite de 110 km/h (padr\~ao em muitas rodovias). Em um dos testes, o
medidor de velocidade indicou uma velocidade de 108 km/h no instante do
in\'icio da frenagem. Sabendo que o carro levou 150 m para parar, qual
\'e o m\'odulo da acelera\c{c}\~ao m\'edia do carro durante a frenagem?
\begin{enumerate}
  \item 2,0 m/s\textsuperscript{2}
  \item 2,5 m/s\textsuperscript{2}
  \item 3,0 m/s\textsuperscript{2}
  \item 3,5 m/s\textsuperscript{2}
  \item 3,8 m/s\textsuperscript{2}
\end{enumerate}
\end{questao}

\begin{questao}{7}{\fonte{ENEM 2009}}
...
\begin{questao}{8}{\fonte{UTFPR Ver\~ao 2025 --- Q53}}
...
\begin{questao}{9}{\selosala\fonte{ENEM 2013}}
...
\begin{questao}{10}{\selosala\fonte{ENEM PPL 2012}}
...
\begin{questao}{11}{\fonte{UTFPR Inverno 2023 --- Q53}}
...
\begin{questao}{12}{\fonte{ENEM PPL 2012}}
...
% ===================================================================
\parte{Parte V --- Revis\~ao e Desafios}
% ===================================================================

\begin{questao}{13}{\fonte{UTFPR Ver\~ao 2024 --- Q53}}
Um m\'ovel, parado, parte em movimento retil\'ineo acelerando, com
acelera\c{c}\~ao constante, igual a 3,5 m/s\textsuperscript{2}. Qual a
sua velocidade escalar e a dist\^ancia percorrida ap\'os 10 s,
respectivamente:
\begin{enumerate}
  \item 17,5 m/s e 350 m.
  \item 35 m/s e 175 m.
  \item 35 m/s e 350 m.
  \item 10 m/s e 350 m.
  \item 3,5 m/s e 17,5 m.
\end{enumerate}
\end{questao}

\begin{questao}{14}{\fonte{UTFPR Ver\~ao 2024 --- Q54}}
No caso da frenagem de um carro que se encontra em movimento
retil\'ineo, com velocidade constante no in\'icio da frenagem e
desacelera\c{c}\~ao constante por uma certa dist\^ancia at\'e que o
carro pare. Sobre o gr\'afico da velocidade em fun\c{c}\~ao do tempo,
\'e correto afirmar que:
\begin{enumerate}
  \item O gr\'afico de frenagem se assemelha a uma reta, ascendente, com
        coeficiente angular positivo e posicionamento inicial do
        coeficiente linear diferente de 0.
  \item O gr\'afico de frenagem se assemelha a uma reta, descendente,
        com coeficiente angular positivo e posicionamento inicial do
        coeficiente linear igual a 0.
  \item O gr\'afico de frenagem se assemelha a uma reta, descendente,
        com coeficiente angular negativo e posicionamento inicial do
        coeficiente linear diferente de 0.
  \item O gr\'afico de frenagem se assemelha a uma semi-par\'abola,
        concavidade para baixo, com o ponto cartesiano em Y, de seu
        v\'ertice, coincidindo com o momento inicial de frenagem
        (diminui\c{c}\~ao de velocidade) e cujo encontro desse gr\'afico
        com o eixo X determina a quantidade de tempo at\'e a parada
        total do m\'ovel.
  \item O gr\'afico de frenagem se assemelha a uma semi-par\'abola,
        concavidade para baixo, com o ponto cartesiano em X, de seu
        v\'ertice, coincidindo com o momento inicial de frenagem
        (diminui\c{c}\~ao de velocidade) e cujo encontro desse gr\'afico
        com o eixo Y determina a quantidade de tempo at\'e a parada
        total do m\'ovel.
\end{enumerate}
\end{questao}

\begin{questao}{15}{\fonte{ENEM 2009}}
...
\begin{questao}{16}{\fonte{UTFPR Ver\~ao 2024 --- Q55}}
...
\begin{tabular}{cccccccccccccccc}
  ...
  \midrule
  A & E & B & A & B & C & D & C & C & E & C & B & B & C & E & D \\
  \bottomrule
\end{tabular}}
\end{center}
...
\item[Q6 --- C (frenagem / Torricelli).]
$v_0 = 108$ km/h $= 30$ m/s. Por Torricelli, com $v = 0$:
$0 = 30^2 - 2a(150) \Rightarrow a = 900/300 = 3{,}0$
m/s\textsuperscript{2}.
\textit{Para usar na aula: se o carro tiver 1000 kg, a for\c{c}a de
frenagem \'e $F = ma = 3000$ N.}

\item[Q7 --- D (massa $\times$ peso).]
...
\item[Q10 --- E (3\textordfeminine{} Lei).]
...
\item[Q11 --- C (3\textordfeminine{} Lei / conserva\c{c}\~ao do momento).]
...
\item[Q12 --- B (atrito est\'atico $\times$ cin\'etico).]
...
\item[Q13 --- B (revis\~ao MRUV).]
$v = at = 3{,}5 \cdot 10 = 35$ m/s;
$d = \tfrac{1}{2}at^2 = \tfrac{1}{2}\cdot 3{,}5\cdot 100 = 175$ m.

\item[Q14 --- C (revis\~ao gr\'afico $v \times t$).]
MRUV de frenagem: reta descendo (coeficiente angular $= a < 0$)
come\c{c}ando de $v_0 \neq 0$ (coeficiente linear diferente de zero).

\item[Q15 --- E (desafio: 2\textordfeminine{} Lei em curva).]
...
\item[Q16 --- D (desafio: conserva\c{c}\~ao do momento).]
...
\begin{itemize}[nosep, leftmargin=1.5em]
  \item \textbf{UTFPR}: provas e gabaritos definitivos oficiais em
        ...
        (edi\c{c}\~oes: Inverno 2023, Ver\~ao 2024, Ver\~ao 2025,
        Ver\~ao 2026).
  \item \textbf{ENEM}: provas do INEP. Enunciados conferidos em
        ...
        caderno azul.
  \item A figura da Q5 foi redesenhada (n\~ao \'e a arte original da
        prova). Para projetar a original, usar o PDF oficial do INEP.
\end{itemize}
\end{painel}
