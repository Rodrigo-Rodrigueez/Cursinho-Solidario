...
\begin{itemize}[nosep]
  \item textbf{Energia \'e o que um sistema
...
vestibulares, projetadas uma por uma e resolvidas ao vivo no quadro.
As quest\~oes est\~ao no arquivo
\texttt{lista\_questoes\_\allowbreak trabalho\_\allowbreak energia.pdf}
(as marcadas com {\scshape\color{vinho}[fazer em sala]}).}
...
\begin{tabular}{@{}cllr@{}}
  ...
  Q13 & Energia dissipada na queda (num\'erica)     & UNIFOR CE          & 5 min \\
  Q1  & Trabalho e o \^angulo da for\c{c}a          & UFF                & 3 min \\
  Q2  & Trabalho do peso independe da trajet\'oria  & UFMG 2003          & 3 min \\
  Q5  & Teorema $W = \Delta E_c$ (num\'erica)       & FGV                & 5 min \\
  Q7  & \'Area do gr\'afico $F \times x$            & UFF                & 5 min \\
  Q17 & Pot\^encia e rendimento (fotovoltaico)      & UTFPR Inv.\ 2023   & 6 min \\
  \bottomrule
\end{tabular}}

\medskip
\textbf{B\^onus}, se sobrar tempo: \textbf{Q8} (ENEM 2011, salto com
vara --- conserva\c{c}\~ao em uma figura s\'o) e \textbf{Q12}
(ENEM 2022, barreira de pneus $\times$ blocos --- for\c{c}a m\'edia e
energia dissipada). As duas s\~ao conceituais e saem em 2 min cada.

\medskip
A ordem \'e a da aula, e \textbf{n\~ao} a ordem num\'erica da lista:
come\c{c}ar pelo trio de conserva\c{c}\~ao (Q10, Q11 e Q13), que \'e o
resultado central e o que mais cai; depois as duas conceituais de
trabalho, que s\~ao r\'apidas e j\'a corrigem o erro de sinal; ent\~ao
o teorema, que \'e a ponte entre a din\^amica e a energia; e o fim fica
com gr\'afico e pot\^encia, que s\~ao os dois formatos preferidos do
ENEM nesse tema.
...
da lista mostra tudo de uma vez.
\end{quadro}
...
\begin{corte}
Menos de 25 min? Fazer Q10, Q13, Q1, Q5 e Q17, que cobrem
conserva\c{c}\~ao, dissipa\c{c}\~ao, trabalho, teorema e pot\^encia.
Menos de 15 min? Q10, Q11 e Q13. Menos de 10? Q10 e Q13.
\end{corte}
...
\begin{tabularx}{\linewidth}{@{}lX@{}}
  ...
  $\approx 1$h30 &
    ...
    (5 min) + 5 quest\~oes (22 min) + fechamento (4 min) \\
  $\approx 2$h &
    Plano completo. Se atrasar, cortar a Q7, porque o gr\'afico volta
    em outros temas, e segurar o ritmo nas conceituais \\
  $\approx 2$h30 &
    Plano completo + resolver uma quest\~ao num\'erica pelos dois
    m\'etodos, energia e $F = ma$, + as duas de b\^onus (Q8 e Q12) +
